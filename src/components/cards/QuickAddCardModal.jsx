                          ...
                          return (
                            <div key={i} className="flex gap-2 items-center">
                              ...
                              {choicesList.length > 2 && (
                                <Button type="button" variant="ghost" size="icon" tabIndex={-1} onClick={() => removeChoice(i)} className="shrink-0 p-0 h-7 w-7 rounded-md bg-muted text-muted-foreground hover:bg-red-100 hover:text-red-600">
