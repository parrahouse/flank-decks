...
export default function DeckInfoTooltip({ deck, totalCards, masteredCount }) {
  ...
  return (
    <span className="relative inline-flex items-center">
      ...
      {open && (
        <span className="absolute top-full left-1/2 -translate-x-1/2 mt-1.5 w-64 rounded-lg bg-foreground text-background text-xs px-3 py-2 z-30 text-left shadow-lg pointer-events-none font-inter">
          {description ? (
