        ...
        <div className={cn('card-flip-inner w-full', flipped && card.explanation && 'flipped')}>
          ...
          <div className="card-face bg-card border border-border rounded-2xl overflow-hidden shadow-sm flex flex-col w-full">
            ...
            <div className="relative w-full bg-muted flex items-center justify-center" style={{ aspectRatio: '4/3' }}>
              {card.image_url ?
              <img src={card.image_url} alt="card" className="absolute inset-0 w-full h-full object-cover rounded-[4px_4px_0px_4px]" /> :
            ...
            <div className="border-t border-border min-h-[2.5rem] flex items-center bg-accent/60 px-4 py-2">
                {clueRevealed ?
              <p className="font-fraunces text-lg text-accent-foreground leading-snug my-2">{card.clue}</p> :
