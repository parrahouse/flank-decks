  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center py-20 gap-3 text-center">
          ...
          <h2 className="font-semibold">No study sessions yet. How sad.</h2>
          <p className="text-muted-foreground text-sm max-w-sm">Complete a study session to begin building a dazzling array of statistics you can show to your mom.</p>
