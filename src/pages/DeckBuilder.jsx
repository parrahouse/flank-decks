...
import { TONE_LIGHT, TONE_DARK, TONE_PLAIN, buildScrim, hexToRgbString, buildScrimGradient } from '@/lib/heroAppearance';
...
export default function DeckBuilder() {
  ...
  const scrimGradient = buildScrimGradient(scrim, fadeTop);
